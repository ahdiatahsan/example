    ...
    <x-slot name="post">
        ...
        <form class="form" action="" method="POST" autocomplete="off" 
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="mb-6">
                        <label class="form-label fs-7 required">Example Text</label>
                    ...
                    <div class="mb-6">
                        <label class="form-label fs-7 required">Example Select</label>
                        <select class="form-select form-select-sm form-select-solid" name="period" id="select2Period"
                            data-placeholder="Example Select" data-allow-clear="true" required>
                        </select>
                    </div>
                    <div class="mb-6">
                    ...
                    <div>
                        <label class="form-label fs-7 required">Example Body</label>
