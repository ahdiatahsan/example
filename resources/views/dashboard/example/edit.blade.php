    ...
    <x-slot name="toolbar">
        <x-dashboard.toolbar.main>
            ...
            <x-slot name="backbutton">
                <!--begin::Button-->
                <a href="" class="btn btn-sm btn-light-success fw-bolder">
            ...
            <div class="card">
                ...
                <div class="card-header">
                    <h3 class="card-title align-items-start flex-column">
                        <span class="card-label fw-bolder text-dark fs-5 my-1">Example</span>
                ...
                <div class="card-body">
                    <div class="mb-6">
                        <label class="form-label fs-7 required">Example Date</label>
                        <div class="input-group">
                            <select class="form-select form-select-sm form-select-solid" name="period"
                                id="select2Period" data-placeholder="Example Date" required>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="input-group input-group-sm pb-3">
                            {{-- <input class="form-control" type="file" name="attachment"
                                {{ $example->attachment == null ? 'required' : '' }} accept=".pdf" /> --}}
                        </div>
                        {{-- @if ($example->attachment != null)
                            <div class="input-group input-group-sm pb-2">
                                <a href="{{ asset('storage/example/' . $example->attachment) }}"
                                    target="_blank">Lihat Berkas</a>
                            </div>
                        @endif --}}
                    </div>
                    <div>
                        <label class="form-label fs-7">Example Body</label>
                        <textarea class="form-control" name="body" id="body" rows="5">{{ $example->body }}</textarea>
                    </div>
                </div>
                <!--end::Card body-->
                <!--begin::Card footer-->
    ...
    <x-slot name="javascript">
        ...
        {{-- <script>
            $('#select2Period').select2({
                ...
                ajax: {
                    url: '{{ route('example.select2-period') }}',
                    dataType: 'json',
                    delay: 250,
